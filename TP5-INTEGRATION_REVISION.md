Pour rendre le fond des formules mathématiques en blanc avec [Codecogs](https://latex.codecogs.com), ajoute le paramètre `?bg=white` à l'URL des images. Voici une version mise à jour :
